...
copy: [C-u _w_]: path from topdir, [C-u 0 _w_]: path from root, "
  ...
  (defhydra hydra-dired (:hint none :color blue)
      "
topdir: %(eval dired-directory)
  ...
  ----------------------------------------------------------------------
    ...
    ^ ^                _M_ chmod         ^ ^               ^ ^
    _w_ copy path      _G_ chgrp         ^ ^               _s_ sort
    _C_ copy           ^ ^               ^ ^               ^ ^
    _R_ rename         Directory         ^ ^               ^ ^
    ^ ^                ---------       _F_ open markedˣ    ^ ^
    ^ ^                _+_ mkdir         _D_ delete marked _C-o_ view other window
    _e_ Ediff          _=_ diff          _A_ find regexp   _o_ other window
    _Z_ compress       _C-M-i_ jump      _Q_ repl regexp   _g_ revert buf
    "
      ...
      ("g" revert-buffer)
      ("M" dired-do-chmod)
      ("m" hydra-marked-items/dired-mark :color teal)
