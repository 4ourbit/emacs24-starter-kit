...
- Activating more of the starter kit :: By default, the starter kit
     ...
     =starter-kit-gnus.org= which are tagged =visual= add
...
- ELPA archive repository and packages to install by default.
  #+begin_src emacs-lisp
...
- Dired modifications in [[file:starter-kit-dired.org][starter-kit-dired]]
  #+begin_src emacs-lisp
...
- Support for bindings that stick around in [[file:starter-kit-hydras.org][starter-kit-hydras]]
  #+begin_src emacs-lisp
    (starter-kit-load "starter-kit-hydras.org")
  #+end_src

- Interface to the version control system Git in [[file:starter-kit-magit.org][starter-kit-magit]]
  #+begin_src emacs-lisp
    (starter-kit-load "starter-kit-magit.org")
  #+end_src

- Interactively do things with buffers and files in [[file:starter-kit-ido.org][starter-kit-ido]]
  #+begin_src emacs-lisp :tangle no
    (starter-kit-load "starter-kit-ido.org")
  #+end_src

- Ivy, a generic completion frontend for Emacs in [[file:starter-kit-ivy.org][starter-kit-ivy]]
  #+begin_src emacs-lisp
    (starter-kit-load "starter-kit-ivy.org")
  #+end_src
