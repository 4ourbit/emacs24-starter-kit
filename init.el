...
(define-key input-decode-map (kbd "s-v") (kbd "C-y"))
(define-key input-decode-map (kbd "s-x") (kbd "C-w"))
(define-key input-decode-map (kbd "s-c") (kbd "M-w"))
(define-key input-decode-map (kbd "s-w") (kbd "C-x k"))
